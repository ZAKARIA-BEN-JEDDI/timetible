                                ...
                                <div class="class-info">
                                    ...
                                    <?php
                                        switch ($slots[$timeSlot]['professeur']) {
                                            case 'Prof PC':
                                                ?><div class="matiere">Physique chimie</div><?php

                                                break;
                                            case 'Prof SVT':
                                                ?><div class="matiere">SVT</div><?php

                                                break;
                                            case 'Prof Histoire':
                                                ?><div class="matiere">Histoire</div><?php
                                            ...
                                            case 'Prof Français':
                                                ...
                                                break;
                                            case 'Prof Maths':
                                                ?><div class="matiere">Maths</div><?php

                                                break;
                                            case 'Prof Anglais':
                                                ?><div class="matiere">Anglais</div><?php

                                                break;
                                            case 'Prof Arabe':
                                                ?><div class="matiere">Arabe</div><?php

                                                break;
                                            case 'Prof Sport':
                                                ?><div class="matiere">Sport</div><?php
                                                break;
                                            
                                            default:
                                                ?><div class="matiere">Matiere non connue</div><?php
                                                break;
                                        }
                                    ?>
